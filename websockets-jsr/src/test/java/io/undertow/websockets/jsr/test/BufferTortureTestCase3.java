 ...
 *
 */
public class BufferTortureTestCase3 extends BufferTortureTestBase {
    ...
    public static void beforeTests() throws DeploymentException, ServletException {
        ...
        DeploymentInfo builder = new DeploymentInfo()
                ...
                .addServletContextAttribute(WebSocketDeploymentInfo.ATTRIBUTE_NAME,
                        ...
                        .addEndpoint(BufferTortureEndpoint.class)
                )
                .setDeploymentName("ws.war");

        System.setProperty(AbstractReceiveListener.WEB_SOCKETS_SIZE_BINARY_PROPERTY, "100000");
        System.setProperty(AbstractReceiveListener.WEB_SOCKETS_SIZE_TEXT_PROPERTY, "100000");
    ...
    public static void afterTest() {
        ...
        System.clearProperty(AbstractReceiveListener.WEB_SOCKETS_SIZE_BINARY_PROPERTY);
        System.clearProperty(AbstractReceiveListener.WEB_SOCKETS_SIZE_TEXT_PROPERTY);
    }

    @ServerEndpoint(value ="/ws", configurator = CustomConfigurator.class)
    public static class BufferTortureEndpoint {
