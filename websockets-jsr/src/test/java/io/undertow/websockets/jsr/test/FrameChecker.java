...
public final class FrameChecker implements WebSocketTestClient.FrameListener {
    ...
    private final CompletableFuture<?> latch;
    private volatile boolean first = true;

    public FrameChecker(Class<? extends WebSocketFrame> clazz, byte[] expectedPayload, CompletableFuture<?> latch) {
        this.clazz = clazz;
    ...
    public void onFrame(WebSocketFrame frame) {
        try {
            ...
            latch.completeExceptionally(new IOException(e));
        }
    }
    ...
    public void onError(Throwable t) {
        try {
            ...
            latch.completeExceptionally(new IOException(t));
        }
    }
}
