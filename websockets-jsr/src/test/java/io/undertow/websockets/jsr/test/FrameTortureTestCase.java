 ...
 *
 */
public class FrameTortureTestCase extends BufferTortureTestBase {
    ...
    public static void beforeTests() throws DeploymentException, ServletException {
        ...
        DeploymentInfo builder = new DeploymentInfo()
                ...
                .addServletContextAttribute(WebSocketDeploymentInfo.ATTRIBUTE_NAME,
                        new WebSocketDeploymentInfo()
                                .addListener(new ContainerReadyListener() {
                                    @Override
        ...
        //DefaultServer.setServerOptions(OptionMap.create(UndertowOptions.WEB_SOCKETS_MAX_READ_FRAMES,
        //        30));
