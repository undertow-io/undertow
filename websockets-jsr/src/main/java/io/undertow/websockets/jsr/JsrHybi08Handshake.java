...
/**
 * {@link Hybi08Handshake} sub-class which takes care of match against the {@link ServerEndpointConfiguration} and
 * stored the config in the attributes for later usage.
 *
 * @author <a href="mailto:nmaurer@redhat.com">Norman Maurer</a>
 */
final class JsrHybi08Handshake extends Hybi08Handshake {
    private final ServerEndpointConfiguration config;

    public JsrHybi08Handshake(ServerEndpointConfiguration config) {
