 ...
 */
public class WebSocketExtensionData {
    ...
    public WebSocketExtensionData(String name, List<Parameter> parameters) {
        this.name = name;
    ...
    public static List<WebSocketExtensionData> parse(final String extensionHeader) {
        if(extensionHeader == null || extensionHeader.isEmpty()) {
            return Collections.emptyList();
        }
        List<WebSocketExtensionData> extensions = new ArrayList<>();
     ...
     *
     * @param extensions list of {@link WebSocketExtensionData}
     * @return           a string representation of the extensions
     */
    public static String toExtensionHeader(final List<WebSocketExtensionData> extensions) {
        StringBuilder extensionsHeader = new StringBuilder();
        if (extensions != null && extensions.size() > 0) {
            Iterator<WebSocketExtensionData> it = extensions.iterator();
            while (it.hasNext()) {
                WebSocketExtensionData extension = it.next();
