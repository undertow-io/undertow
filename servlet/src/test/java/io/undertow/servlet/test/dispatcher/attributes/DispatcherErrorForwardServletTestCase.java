...
public class DispatcherErrorForwardServletTestCase extends AttributeComparisonTestBase {
    ...
    public void testSimpleForwardWithError() throws IOException, InterruptedException {
        ...
        expectedParams.put("javax.servlet.forward.request_uri", "/servletContext/forward");
        expectedParams.put("javax.servlet.forward.servlet_path", "/forward");
        ...
        expectedParams.put("javax.servlet.error.request_uri", "/servletContext/forward");
        expectedParams.put("javax.servlet.error.servlet_name", "fwd");
