...
public class SimpleAsyncTestCase {
    ...
    public void testDispatchAttributes() throws IOException {
        ...
        try {
            ...
            MatcherAssert.assertThat(response, CoreMatchers.containsString("javax.servlet.async.request_uri:/servletContext/dispatch\r\n"));
            MatcherAssert.assertThat(response, CoreMatchers.containsString("javax.servlet.async.context_path:/servletContext\r\n"));
            MatcherAssert.assertThat(response, CoreMatchers.containsString("javax.servlet.async.servlet_path:/dispatch\r\n"));
            MatcherAssert.assertThat(response, CoreMatchers.containsString("javax.servlet.async.path_info:null\r\n"));
            MatcherAssert.assertThat(response, CoreMatchers.containsString("javax.servlet.async.query_string:n1=v1&n2=v2\r\n"));
        } finally {
            client.getConnectionManager().shutdown();
        }
    }
    ...
    public void testDispatchAttributesEncoded() throws IOException {
        ...
        try {
            ...
            MatcherAssert.assertThat(response, CoreMatchers.containsString("javax.servlet.async.request_uri:/servletContext/dispatch/dis%25patch\r\n"));
            MatcherAssert.assertThat(response, CoreMatchers.containsString("javax.servlet.async.context_path:/servletContext\r\n"));
            MatcherAssert.assertThat(response, CoreMatchers.containsString("javax.servlet.async.servlet_path:/dispatch\r\n"));
            MatcherAssert.assertThat(response, CoreMatchers.containsString("javax.servlet.async.path_info:/dis%patch\r\n"));
            MatcherAssert.assertThat(response, CoreMatchers.containsString("javax.servlet.async.query_string:n1=v%251&n2=v2\r\n"));
        } finally {
            client.getConnectionManager().shutdown();
        }
    }
    ...
    public void testDispatchAttributesEncodedExtension() throws IOException {
        ...
        try {
            ...
            MatcherAssert.assertThat(response, CoreMatchers.containsString("javax.servlet.async.request_uri:/servletContext/dis%25patch.dispatch\r\n"));
            MatcherAssert.assertThat(response, CoreMatchers.containsString("javax.servlet.async.context_path:/servletContext\r\n"));
            MatcherAssert.assertThat(response, CoreMatchers.containsString("javax.servlet.async.servlet_path:/dis%patch.dispatch\r\n"));
            MatcherAssert.assertThat(response, CoreMatchers.containsString("javax.servlet.async.path_info:null\r\n"));
            MatcherAssert.assertThat(response, CoreMatchers.containsString("javax.servlet.async.query_string:n1=v%251&n2=v2\r\n"));
        } finally {
            client.getConnectionManager().shutdown();
