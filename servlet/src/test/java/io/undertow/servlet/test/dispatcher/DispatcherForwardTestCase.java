...
public class DispatcherForwardTestCase {
    ...
    public void testAttributes() throws IOException {
        ...
        try {
            ...
            MatcherAssert.assertThat(response, CoreMatchers.containsString("javax.servlet.forward.request_uri:/servletContext/dispatch\r\n"));
            MatcherAssert.assertThat(response, CoreMatchers.containsString("javax.servlet.forward.context_path:/servletContext\r\n"));
            MatcherAssert.assertThat(response, CoreMatchers.containsString("javax.servlet.forward.servlet_path:/dispatch\r\n"));
            MatcherAssert.assertThat(response, CoreMatchers.containsString("javax.servlet.forward.path_info:null\r\n"));
            MatcherAssert.assertThat(response, CoreMatchers.containsString("javax.servlet.forward.query_string:n1=v1&n2=v2\r\n"));
        } finally {
            client.getConnectionManager().shutdown();
        }
    }
    ...
    public void testAttributesEncoded() throws IOException {
        ...
        try {
            ...
            MatcherAssert.assertThat(response, CoreMatchers.containsString("javax.servlet.forward.request_uri:/servletContext/dispatch/dispatch%25info\r\n"));
            MatcherAssert.assertThat(response, CoreMatchers.containsString("javax.servlet.forward.context_path:/servletContext\r\n"));
            MatcherAssert.assertThat(response, CoreMatchers.containsString("javax.servlet.forward.servlet_path:/dispatch\r\n"));
            MatcherAssert.assertThat(response, CoreMatchers.containsString("javax.servlet.forward.path_info:/dispatch%info\r\n"));
            MatcherAssert.assertThat(response, CoreMatchers.containsString("javax.servlet.forward.query_string:n1=v%251&n2=v%252\r\n"));
        } finally {
            client.getConnectionManager().shutdown();
        }
    }
    ...
    public void testAttributesEncodedExtension() throws IOException {
        ...
        try {
            ...
            MatcherAssert.assertThat(response, CoreMatchers.containsString("javax.servlet.forward.request_uri:/servletContext/dis%25patch/dispatch%25info.dispatch\r\n"));
            MatcherAssert.assertThat(response, CoreMatchers.containsString("javax.servlet.forward.context_path:/servletContext\r\n"));
            MatcherAssert.assertThat(response, CoreMatchers.containsString("javax.servlet.forward.servlet_path:/dis%patch/dispatch%info.dispatch\r\n"));
            MatcherAssert.assertThat(response, CoreMatchers.containsString("javax.servlet.forward.path_info:null\r\n"));
            MatcherAssert.assertThat(response, CoreMatchers.containsString("javax.servlet.forward.query_string:n1=v%251&n2=v%252\r\n"));
            MatcherAssert.assertThat(response, CoreMatchers.containsString("javax.servlet.forward.mapping:"));
        } finally {
            client.getConnectionManager().shutdown();
        }
    }
    ...
    public void testDisptacherServletForward() throws IOException, InterruptedException {
        ...
        try {
            ...
            assertTrue(DispatcherUtil.containsWord(response,"javax.servlet.forward.context_path"));
            assertTrue(DispatcherUtil.containsWord(response,"javax.servlet.forward.servlet_path"));
            assertTrue(DispatcherUtil.containsWord(response,"javax.servlet.forward.request_uri"));
            assertTrue(DispatcherUtil.containsWord(response,"javax.servlet.forward.mapping"));
