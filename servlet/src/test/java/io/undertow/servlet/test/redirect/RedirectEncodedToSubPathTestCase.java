...
public class RedirectEncodedToSubPathTestCase {
    @BeforeClass
    public static void setup() throws ServletException {
        ...
        DeploymentInfo builder = new DeploymentInfo()
                ...
                .addServlets(
                        servlet("redirect", RedirectEncodedServlet.class)
                                .addMapping("/redirect/*"));
    ...
    public void testServletRedirect() throws Exception {
        //test redirects
        runtest("/servletContext/redirect/", "/servletContext/redirect/invalid-%5B123%5D/subpath");
    }
