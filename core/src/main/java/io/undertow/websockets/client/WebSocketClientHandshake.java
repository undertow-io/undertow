...
public abstract class WebSocketClientHandshake {
    ...
    public abstract WebSocketChannel createChannel(final StreamConnection channel, final String wsUri, final ByteBufferPool bufferPool, UndertowOptionMap options);
