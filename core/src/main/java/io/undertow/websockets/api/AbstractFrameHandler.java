...
/**
 * Adapter classs for {@link FrameHandler}.  Sub-classes can override the methods to provide
 * an implementation.
 *
...
public abstract class AbstractFrameHandler implements FrameHandler {
     ...
     */
    @Override
    public void onPingFrame(WebSocketSession session, ByteBuffer... payload) {
        // NOOP
    }
