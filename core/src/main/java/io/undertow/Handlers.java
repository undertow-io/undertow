...
public class Handlers {
     ...
     * @return
     */
    public static RateLimitingHandler rateLimitingHandler(final RateLimiter<HttpServerExchange, HttpServerExchange> limiter, final String statusMessage, final int statusCode, final boolean enforced, final boolean signalLimit, final HttpHandler next) {
