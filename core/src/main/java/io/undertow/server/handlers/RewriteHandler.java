...
/**
 * @author <a href="mailto:bbaranow@ibm.com">Bartosz Baranowski</a>
 * @author Stuart Douglas
 */
public class RewriteHandler extends SetAttributeHandler {

    public RewriteHandler(HttpHandler next, ExchangeAttribute value) {
        super(next, ExchangeAttributes.relativePath(), value);
    }

    @Override
    public void handleRequest(HttpServerExchange exchange) throws Exception {
        UndertowLogger.PREDICATE_LOGGER.debugf("Request rewritten to [%s] for %s.", getValue().readAttribute(exchange),
                exchange);
    ...
    public static class Builder implements HandlerBuilder {
        ...
        public Map<String, Class<?>> parameters() {
            return Map.of("value", ExchangeAttribute.class);
        }
        ...
        public HandlerWrapper build(final Map<String, Object> config) {
            ...
            return new HandlerWrapper() {
                ...
                public HttpHandler wrap(HttpHandler handler) {
                    return new RewriteHandler(handler, value);
                }
