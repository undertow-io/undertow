...
public interface RateLimiter<K, V> {
     ...
     * @return
     */
    int timeToWindowSlide(HttpServerExchange exchange);
     ...
     * @return
     */
    int increment(HttpServerExchange exchange);
     ...
     *         hits.
     */
    int current(HttpServerExchange exchange);
    ...
    default String getRemainingQuota(HttpServerExchange exchange) {
