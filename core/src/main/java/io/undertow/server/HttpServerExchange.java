...
public final class HttpServerExchange extends AbstractAttachable {
    ...
    public Map<String, Cookie> getRequestCookies() {
        if (deprecatedRequestCookies == null) {
            deprecatedRequestCookies = new MapDelegatingToMultimap(((DelegatingIterable<String,Cookie>)requestCookies()).getDelegate());
        }
    ...
    public Iterable<Cookie> requestCookies() {
        if (requestCookies == null) {
            OverridableLinkedMultimap<String,Cookie> requestCookiesParam = new OverridableLinkedMultimap<String, Cookie>(ArrayListMultimap.create());
    ...
    public Map<String, Cookie> getResponseCookies() {
        if (deprecatedResponseCookies == null) {
            deprecatedResponseCookies = new MapDelegatingToMultimap(((DelegatingIterable<String,Cookie>)responseCookies()).getDelegate());
        }
    ...
    public Iterable<Cookie> responseCookies() {
        if (responseCookies == null) {
            responseCookies = new DelegatingIterable<>(new OverridableLinkedMultimap(ArrayListMultimap.create()));
        }
