...
public class Cookies {
    ...
    /**
    *
    * @deprecated use {@link #parseRequestCookies(int, boolean, List, MultiValueHashListStorage, boolean)}
    */
    ...
    public static void parseRequestCookies(int maxCookies, boolean allowEqualInValue, List<String> cookies, MultiValueHashListStorage<String, Cookie> parsedCookies, boolean rfc6265ParsingDisabled) {
    ...
    */
   @Deprecated(since="2.4.0", forRemoval=true)
   static void parseRequestCookies(int maxCookies, boolean allowEqualInValue, List<String> cookies, Set<Cookie> parsedCookies, boolean commaIsSeperator,  boolean rfc6265ParsingDisabled) {
       parseRequestCookies(maxCookies, allowEqualInValue, cookies, parsedCookies, commaIsSeperator, LegacyCookieSupport.ALLOW_HTTP_SEPARATORS_IN_V0, rfc6265ParsingDisabled);
   }

   static void parseRequestCookies(int maxCookies, boolean allowEqualInValue, List<String> cookies, MultiValueHashListStorage<String, Cookie> parsedCookies, boolean commaIsSeperator, boolean rfc6265ParsingDisabled) {
       parseRequestCookies(maxCookies, allowEqualInValue, cookies, parsedCookies, commaIsSeperator, LegacyCookieSupport.ALLOW_HTTP_SEPARATORS_IN_V0, rfc6265ParsingDisabled);
   }
    ...
    */
   @Deprecated(since="2.4.0", forRemoval=true)
    static void parseRequestCookies(int maxCookies, boolean allowEqualInValue, List<String> cookies, Set<Cookie> retVal, boolean commaIsSeperator, boolean allowHttpSepartorsV0, boolean rfc6265ParsingDisabled) {
       if (cookies != null) {
           final MultiValueHashListStorage<String, Cookie> parsedCookies = new MultiValueHashListStorage<>();
           for (String cookie : cookies) {
                parseCookie(cookie, parsedCookies, maxCookies, allowEqualInValue, commaIsSeperator, allowHttpSepartorsV0, rfc6265ParsingDisabled);
