...
public final class Headers {
    ...
    public static final HttpString COOKIE = new HttpString(COOKIE_STRING, 11);
    public static final HttpString COOKIE2 = new HttpString(COOKIE2_STRING, 12);
    public static final HttpString CONNECTION = new HttpString(CONNECTION_STRING, 13);
    public static final HttpString CONTENT_DISPOSITION = new HttpString(CONTENT_DISPOSITION_STRING, 14);
    public static final HttpString CONTENT_ENCODING = new HttpString(CONTENT_ENCODING_STRING, 15);
    public static final HttpString CONTENT_LANGUAGE = new HttpString(CONTENT_LANGUAGE_STRING, 16);
    public static final HttpString CONTENT_LENGTH = new HttpString(CONTENT_LENGTH_STRING, 17);
    public static final HttpString CONTENT_LOCATION = new HttpString(CONTENT_LOCATION_STRING, 18);
    public static final HttpString CONTENT_MD5 = new HttpString(CONTENT_MD5_STRING,19);
    public static final HttpString CONTENT_RANGE = new HttpString(CONTENT_RANGE_STRING, 20);
    public static final HttpString CONTENT_TYPE = new HttpString(CONTENT_TYPE_STRING, 21);
