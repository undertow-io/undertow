...
public final class Headers {
    ...
    public static final HttpString FORWARDED = new HttpString(FORWARDED_STRING, 26);
    public static final HttpString FROM = new HttpString(FROM_STRING, 27);
    public static final HttpString HOST = new HttpString(HOST_STRING, 28);
    public static final HttpString IF_MATCH = new HttpString(IF_MATCH_STRING, 29);
    public static final HttpString IF_MODIFIED_SINCE = new HttpString(IF_MODIFIED_SINCE_STRING, 30);
    public static final HttpString IF_NONE_MATCH = new HttpString(IF_NONE_MATCH_STRING, 31);
    public static final HttpString IF_RANGE = new HttpString(IF_RANGE_STRING, 32);
    public static final HttpString IF_UNMODIFIED_SINCE = new HttpString(IF_UNMODIFIED_SINCE_STRING, 33);
    public static final HttpString LAST_MODIFIED = new HttpString(LAST_MODIFIED_STRING, 34);
    public static final HttpString LOCATION = new HttpString(LOCATION_STRING, 35);
    public static final HttpString MAX_FORWARDS = new HttpString(MAX_FORWARDS_STRING, 36);
    public static final HttpString ORIGIN = new HttpString(ORIGIN_STRING, 37);
    public static final HttpString PRAGMA = new HttpString(PRAGMA_STRING, 38);
    public static final HttpString PROXY_AUTHENTICATE = new HttpString(PROXY_AUTHENTICATE_STRING, 39);
    public static final HttpString PROXY_AUTHORIZATION = new HttpString(PROXY_AUTHORIZATION_STRING, 40);
    public static final HttpString RANGE = new HttpString(RANGE_STRING, 41);
    public static final HttpString REFERER = new HttpString(REFERER_STRING, 42);
    public static final HttpString REFRESH = new HttpString(REFRESH_STRING, 43);
    public static final HttpString RETRY_AFTER = new HttpString(RETRY_AFTER_STRING, 44);
    public static final HttpString SEC_WEB_SOCKET_ACCEPT = new HttpString(SEC_WEB_SOCKET_ACCEPT_STRING, 45);
    public static final HttpString SEC_WEB_SOCKET_EXTENSIONS = new HttpString(SEC_WEB_SOCKET_EXTENSIONS_STRING, 46);
    public static final HttpString SEC_WEB_SOCKET_KEY = new HttpString(SEC_WEB_SOCKET_KEY_STRING, 47);
    public static final HttpString SEC_WEB_SOCKET_KEY1 = new HttpString(SEC_WEB_SOCKET_KEY1_STRING, 48);
    public static final HttpString SEC_WEB_SOCKET_KEY2 = new HttpString(SEC_WEB_SOCKET_KEY2_STRING, 49);
    public static final HttpString SEC_WEB_SOCKET_LOCATION = new HttpString(SEC_WEB_SOCKET_LOCATION_STRING, 50);
    public static final HttpString SEC_WEB_SOCKET_ORIGIN = new HttpString(SEC_WEB_SOCKET_ORIGIN_STRING, 51);
    public static final HttpString SEC_WEB_SOCKET_PROTOCOL = new HttpString(SEC_WEB_SOCKET_PROTOCOL_STRING, 52);
    public static final HttpString SEC_WEB_SOCKET_VERSION = new HttpString(SEC_WEB_SOCKET_VERSION_STRING, 53);
    public static final HttpString SERVER = new HttpString(SERVER_STRING, 54);
    public static final HttpString SERVLET_ENGINE = new HttpString(SERVLET_ENGINE_STRING, 55);
    public static final HttpString SET_COOKIE = new HttpString(SET_COOKIE_STRING, 56);
    public static final HttpString SET_COOKIE2 = new HttpString(SET_COOKIE2_STRING, 57);
    public static final HttpString SSL_CIPHER = new HttpString(SSL_CIPHER_STRING, 58);
    public static final HttpString SSL_CIPHER_USEKEYSIZE = new HttpString(SSL_CIPHER_USEKEYSIZE_STRING, 59);
    public static final HttpString SSL_CLIENT_CERT = new HttpString(SSL_CLIENT_CERT_STRING, 60);
    public static final HttpString SSL_SESSION_ID = new HttpString(SSL_SESSION_ID_STRING, 61);
    public static final HttpString STATUS = new HttpString(STATUS_STRING, 62);
    public static final HttpString STRICT_TRANSPORT_SECURITY = new HttpString(STRICT_TRANSPORT_SECURITY_STRING, 63);
    public static final HttpString TE = new HttpString(TE_STRING, 64);
    public static final HttpString TRAILER = new HttpString(TRAILER_STRING, 65);
    public static final HttpString TRANSFER_ENCODING = new HttpString(TRANSFER_ENCODING_STRING, 66);
    public static final HttpString UPGRADE = new HttpString(UPGRADE_STRING, 67);
    public static final HttpString USER_AGENT = new HttpString(USER_AGENT_STRING, 68);
    public static final HttpString VARY = new HttpString(VARY_STRING, 69);
    public static final HttpString VIA = new HttpString(VIA_STRING, 70);
    public static final HttpString WARNING = new HttpString(WARNING_STRING, 71);
    public static final HttpString WWW_AUTHENTICATE = new HttpString(WWW_AUTHENTICATE_STRING, 72);
    public static final HttpString X_DISABLE_PUSH = new HttpString(X_DISABLE_PUSH_STRING, 73);
    public static final HttpString X_FORWARDED_FOR = new HttpString(X_FORWARDED_FOR_STRING, 74);
    public static final HttpString X_FORWARDED_HOST = new HttpString(X_FORWARDED_HOST_STRING, 75);
    public static final HttpString X_FORWARDED_PORT = new HttpString(X_FORWARDED_PORT_STRING, 76);
    public static final HttpString X_FORWARDED_PROTO = new HttpString(X_FORWARDED_PROTO_STRING, 77);
    public static final HttpString X_FORWARDED_SERVER = new HttpString(X_FORWARDED_SERVER_STRING, 78);
