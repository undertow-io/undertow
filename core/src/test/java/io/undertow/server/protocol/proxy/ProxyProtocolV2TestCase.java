...
public class ProxyProtocolV2TestCase {
    ...
    public void testProxyProtocolTcp4() throws Exception {
        ...
        byte[] header = getProxyHeader(PROXY, TCPv4, 12, InetAddress.getByName("1.2.3.4"), InetAddress.getByName("5.6.7.8"),444,555);
        ...
        // check port range
        header = getProxyHeader(PROXY, TCPv4, 12, InetAddress.getByName("1.2.3.4"), InetAddress.getByName("5.6.7.8"),0,65535);
        expectedResponse = "result: /1.2.3.4:0 /5.6.7.8:65535";
        proxyProtocolRequestResponseCheck(header, requestHttp, expectedResponse);

        // check extra len
        header = getProxyHeader(PROXY, TCPv4, 100, InetAddress.getByName("1.2.3.4"), InetAddress.getByName("5.6.7.8"),444,555);
    ...
    public void testProxyProtocolTcp4Negative() throws Exception {
        ...
        request = getProxyHeader(PROXY, TCPv4, 10, InetAddress.getByName("1.2.3.4"), InetAddress.getByName("5.6.7.8"),444,null);
        proxyProtocolRequestResponseCheck(request, requestHttp, "");

        // missing destination address
        request = getProxyHeader(PROXY, TCPv4, 8, InetAddress.getByName("1.2.3.4"), null,444,555);
        proxyProtocolRequestResponseCheck(request, requestHttp, "");

        // invalid family
        request = getProxyHeader(PROXY, (byte) 0x42, 12, InetAddress.getByName("1.2.3.4"), InetAddress.getByName("5.6.7.8"),444,555);
        proxyProtocolRequestResponseCheck(request, requestHttp, "");

        // len too low
        request = getProxyHeader(PROXY, TCPv4, 4, InetAddress.getByName("1.2.3.4"), null,null,null);
        proxyProtocolRequestResponseCheck(request, requestHttp, "");
    }
    ...
    public void testProxyProtocolTcp6() throws Exception {
        ...
        // simple valid request
        request = getProxyHeader(PROXY, TCPv6, 36, InetAddress.getByName("fe80::56ee:75ff:fe44:85bc"), InetAddress.getByName("fe80::5ec5:d4ff:fede:66d8"),444,555);
        ...
        // check port range
        request = getProxyHeader(PROXY, TCPv6, 36, InetAddress.getByName("fe80::56ee:75ff:fe44:85bc"), InetAddress.getByName("fe80::5ec5:d4ff:fede:66d8"),0,65535);
    ...
    public void testProxyProtocolTcp6Negative() throws Exception {
        ...
        // missing destination port
        request = getProxyHeader(PROXY, TCPv6, 34, InetAddress.getByName("fe80::56ee:75ff:fe44:85bc"), InetAddress.getByName("fe80::5ec5:d4ff:fede:66d8"),444,null);
        proxyProtocolRequestResponseCheck(request, requestHttp, "");

        // missing destination address
        request = getProxyHeader(PROXY, TCPv6, 20, InetAddress.getByName("1.2.3.4"), null,444,555);
        proxyProtocolRequestResponseCheck(request, requestHttp, "");

        // invalid family
        request = getProxyHeader(PROXY, (byte) 0x42, 36, InetAddress.getByName("fe80::56ee:75ff:fe44:85bc"), InetAddress.getByName("fe80::5ec5:d4ff:fede:66d8"),444,555);
        proxyProtocolRequestResponseCheck(request, requestHttp, "");

        // len too low
        request = getProxyHeader(PROXY, TCPv6, 16, InetAddress.getByName("fe80::56ee:75ff:fe44:85bc"), null,null,null);
        proxyProtocolRequestResponseCheck(request, requestHttp, "");
    }

    @Test
    public void testProxyProtocolLocal() throws Exception {
        String requestHttp = "GET / HTTP/1.0\r\n\r\n";
        byte[] request;

        // simple valid request
        request = getProxyHeader(LOCAL, (byte) 0, 0, null, null,null,null);
    ...
    public void testProxyProtocolNegative() throws Exception {
        ...
        // wrong version
        request = getProxyHeader((byte) 0, TCPv4, 12, InetAddress.getByName("1.2.3.4"), InetAddress.getByName("5.6.7.8"),444,555);
        proxyProtocolRequestResponseCheck(request, requestHttp, "");
    ...
    private byte[] getProxyHeader(Byte ver_cmd, Byte family, Integer len, InetAddress sourceAddress, InetAddress destAddress, Integer sourcePort, Integer destPort) {
...
//    private byte[] parseHeader(String content) {
//        request = "PROXY TCP4 1.2.3.4 5.6.7.8 444\r\nGET / HTTP/1.0\r\n\r\n";
//
//        String header = content.substring(0, content.indexOf("\r\n"));
//        String httpRequest = content.substring(content.indexOf("\r\n") + 2);
//
