    ...
    public static void setup() {
        HttpHandler lotsOfSendsHandler = new HttpHandler() {
            ...
            public void handleRequest(final HttpServerExchange exchange) throws Exception {
                ...
                class SendClass implements Runnable, IoCallback<Sender> {
        ...
        HttpHandler lotsOfTransferHandler = new HttpHandler() {
            ...
            public void handleRequest(final HttpServerExchange exchange) throws Exception {
                ...
                exchange.setResponseContentLength(raf.length() * TXS);
                ...
                class SendClass implements Runnable, IoCallback<Sender> {
                    ...
                    public void onComplete(final HttpServerExchange exchange, final Sender sender) {
                        ...
                        exchange.getResponseSender().transferFrom(raf, this);
                    }
