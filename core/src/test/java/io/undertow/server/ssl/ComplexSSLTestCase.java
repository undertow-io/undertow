...
public class ComplexSSLTestCase {
    ...
    @Test
    public void complexSSLTestCase() throws IOException, URISyntaxException {
        ...
        try (CloseableHttpClient client = TestHttpClient.withSSLContext(DefaultServer.getClientSSLContext()).build()) {
            ...
            client.execute(getFileList, resultList -> {
                Assert.assertEquals(StatusCodes.OK, resultList.getCode());
    ...
    public void testSslLotsOfData() throws IOException, GeneralSecurityException, URISyntaxException {
        ...
        try (CloseableHttpClient client = TestHttpClient.withSSLContext(DefaultServer.getClientSSLContext()).build()) {
            ...
            client.execute(post, resultList -> {
                Assert.assertEquals(StatusCodes.OK, resultList.getCode());
