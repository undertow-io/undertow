...
public interface UndertowXnioLogger extends BasicLogger {

    UndertowXnioLogger ROOT_LOGGER = Logger.getMessageLogger(UndertowXnioLogger.class, UndertowXnioLogger.class.getPackage().getName());
    UndertowXnioLogger CLIENT_LOGGER = Logger.getMessageLogger(UndertowXnioLogger.class, "io.undertow.client");

    UndertowXnioLogger REQUEST_LOGGER = Logger.getMessageLogger(UndertowXnioLogger.class, UndertowXnioLogger.class.getPackage().getName() + ".request");
    UndertowXnioLogger SESSION_LOGGER = Logger.getMessageLogger(UndertowXnioLogger.class, UndertowXnioLogger.class.getPackage().getName() + ".session");
    UndertowXnioLogger SECURITY_LOGGER = Logger.getMessageLogger(UndertowXnioLogger.class, UndertowXnioLogger.class.getPackage().getName() + ".request.security");
    UndertowXnioLogger PROXY_REQUEST_LOGGER = Logger.getMessageLogger(UndertowXnioLogger.class, UndertowXnioLogger.class.getPackage().getName() + ".proxy");
    UndertowXnioLogger REQUEST_DUMPER_LOGGER = Logger.getMessageLogger(UndertowXnioLogger.class, UndertowXnioLogger.class.getPackage().getName() + ".request.dump");
    /**
     ...
     */
    UndertowXnioLogger REQUEST_IO_LOGGER = Logger.getMessageLogger(UndertowXnioLogger.class, UndertowXnioLogger.class.getPackage().getName() + ".request.io");
    UndertowXnioLogger ERROR_RESPONSE = Logger.getMessageLogger(UndertowXnioLogger.class, UndertowXnioLogger.class.getPackage().getName() + ".request.error-response");
...
//    void couldNotInitiateHttp2Connection();
    ...
    void mcmpKeyValue(Object name, String value);
    ...
    void mcmpSendingResponse(InetSocketAddress destination, int status, Object headers, String response);
    ...
    void failedToInvokeFailedCallback(Object callback, @Cause Exception e);
    ...
    void sslReadLoopDetected(Object sslConduit);
    ...
    void sslBufferOverflow(Object sslConduit);
...
//    void alpnConnectionFailed(@Cause Exception e);
    ...
    void cannotProxyStartedRequest(Object exchange);
    ...
    void responseWasNotTerminated(Object connection, Object exchange);
