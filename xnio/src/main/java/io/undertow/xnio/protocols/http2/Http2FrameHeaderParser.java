...
import static io.undertow.xnio.protocols.http2.Http2Channel.DATA_FLAG_END_STREAM;
import static io.undertow.xnio.protocols.http2.Http2Channel.FRAME_TYPE_CONTINUATION;
import static io.undertow.xnio.protocols.http2.Http2Channel.FRAME_TYPE_DATA;
import static io.undertow.xnio.protocols.http2.Http2Channel.FRAME_TYPE_GOAWAY;
import static io.undertow.xnio.protocols.http2.Http2Channel.FRAME_TYPE_HEADERS;
import static io.undertow.xnio.protocols.http2.Http2Channel.FRAME_TYPE_PRIORITY;
import static io.undertow.xnio.protocols.http2.Http2Channel.FRAME_TYPE_PUSH_PROMISE;
import static io.undertow.xnio.protocols.http2.Http2Channel.FRAME_TYPE_RST_STREAM;
import static io.undertow.xnio.protocols.http2.Http2Channel.FRAME_TYPE_SETTINGS;
import static io.undertow.xnio.protocols.http2.Http2Channel.FRAME_TYPE_WINDOW_UPDATE;
import static io.undertow.xnio.protocols.http2.Http2Channel.HEADERS_FLAG_END_HEADERS;
    ...
    public boolean handle(final ByteBuffer byteBuffer) throws IOException {
        if (parser == null) {
            ...
            if(continuationParser != null && type != FRAME_TYPE_CONTINUATION) {
                throw new ConnectionErrorException(Http2Channel.ERROR_PROTOCOL_ERROR, UndertowXnioMessages.MESSAGES.expectedContinuationFrame());
            }
            switch (type) {
                case FRAME_TYPE_DATA: {
                    if (streamId == 0) {
                        throw new ConnectionErrorException(Http2Channel.ERROR_PROTOCOL_ERROR, UndertowXnioMessages.MESSAGES.streamIdMustNotBeZeroForFrameType(Http2Channel.FRAME_TYPE_DATA));
                    }
                ...
                case FRAME_TYPE_HEADERS: {
                    if (streamId == 0) {
                        throw new ConnectionErrorException(Http2Channel.ERROR_PROTOCOL_ERROR, UndertowXnioMessages.MESSAGES.streamIdMustNotBeZeroForFrameType(Http2Channel.FRAME_TYPE_HEADERS));
                    }
                ...
                case FRAME_TYPE_RST_STREAM: {
                    if(length != 4) {
                        throw new ConnectionErrorException(Http2Channel.ERROR_FRAME_SIZE_ERROR, UndertowXnioMessages.MESSAGES.incorrectFrameSize());
                    }
                ...
                case FRAME_TYPE_CONTINUATION: {
                    if(continuationParser == null) {
                        ...
                        throw UndertowXnioMessages.MESSAGES.http2ContinuationFrameNotExpected();
                    }
                ...
                case FRAME_TYPE_GOAWAY: {
                    if (streamId != 0) {
                        throw new ConnectionErrorException(Http2Channel.ERROR_PROTOCOL_ERROR, UndertowXnioMessages.MESSAGES.streamIdMustBeZeroForFrameType(Http2Channel.FRAME_TYPE_GOAWAY));
                    }
                ...
                case Http2Channel.FRAME_TYPE_PING: {
                    if (length != 8) {
                        throw new ConnectionErrorException(Http2Channel.ERROR_FRAME_SIZE_ERROR, UndertowXnioMessages.MESSAGES.invalidPingSize());
                    }
                    if (streamId != 0) {
                        throw new ConnectionErrorException(Http2Channel.ERROR_PROTOCOL_ERROR, UndertowXnioMessages.MESSAGES.streamIdMustBeZeroForFrameType(Http2Channel.FRAME_TYPE_PING));
                    }
                ...
                case FRAME_TYPE_SETTINGS: {
                    ...
                    if (streamId != 0) {
                        throw new ConnectionErrorException(Http2Channel.ERROR_PROTOCOL_ERROR, UndertowXnioMessages.MESSAGES.streamIdMustBeZeroForFrameType(Http2Channel.FRAME_TYPE_SETTINGS));
                    }
                ...
                case FRAME_TYPE_PRIORITY: {
                    ...
                    if (streamId == 0) {
                        throw new ConnectionErrorException(Http2Channel.ERROR_PROTOCOL_ERROR, UndertowXnioMessages.MESSAGES.streamIdMustNotBeZeroForFrameType(Http2Channel.FRAME_TYPE_PRIORITY));
                    }
        ...
        if (type == FRAME_TYPE_DATA ||
            ...
            if(channel != null) {
                if(anyAreClear(flags, Http2Channel.HEADERS_FLAG_END_STREAM)) {
                    ...
                    UndertowXnioLogger.REQUEST_IO_LOGGER.debug("Received HTTP/2 trailers header without end stream set");
                    http2Channel.sendGoAway(Http2Channel.ERROR_PROTOCOL_ERROR);
                }
